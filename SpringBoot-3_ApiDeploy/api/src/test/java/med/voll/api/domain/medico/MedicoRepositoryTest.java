...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenario1() {
		...
		var paciente = cadastrarPaciente("Paciente", "paciente@gmail.com", "999.999.999-99");
	...
	private DadosCadastroMedicoDTO dadosMedico(String nome, String email, String crm, Especialidade especialidade) {
		return new DadosCadastroMedicoDTO(nome, email, "61999999999", crm, especialidade, dadosEndereco());
	}

	private DadosCadastroPacienteDTO dadosPaciente(String nome, String email, String cpf) {
		return new DadosCadastroPacienteDTO(nome, email, "61999999999", cpf, dadosEndereco());
	}

	private DadosEnderecoDTO dadosEndereco() {
		return new DadosEnderecoDTO("rua x", "bairro", "0000000", "Brasilia", "DF", null, null);
	}
